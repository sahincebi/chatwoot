...
- Calistirilan Komutlar:
  - (yok)
- Dogrulama:
  - /app/accounts/:id/support/new formu gonder -> toast ǣTicket ID/No ve /support/ticketse redirect.
- Notlar / Riskler:
...
- Amac: Kalici kapasite iyilestirmesi olarak burst mesajlarda eski incoming mesajlarin AI tarafinda islenmesini engellemek ve çoklu yöntemle dogrulamak.
- Sorun / Belirti:
